---
name: case-visualization-specialist
...
profession:
  ...
  zh: "可视化专员"
maxTurns: 50
provenBy: "plugin.json case-visualization-specialist (可视化专员) / agent-template 模板"
verified: false
---
...
- 上游：案情、证据（evidence-analyst）、程序状态（case-manager）
- 用户输入：事实描述、材料
