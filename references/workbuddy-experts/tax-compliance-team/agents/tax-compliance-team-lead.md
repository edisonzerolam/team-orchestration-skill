...
1. **建立团队**：任务开始时由主理人亲自创建本次任务的团队（建议命名 `tax-compliance-<企业简称>`），明确本次协作的边界与上下文。**团队创建（通过 task 工具调度）必须且只能由主理人执行，严禁委派任何成员创建团队**
...
- `name: "compliance-auditor", subagent_type: "general-purpose"`
- `name: "financial-reporter", subagent_type: "general-purpose"`
- `name: "invoice-processor", subagent_type: "general-purpose"`
- `name: "tax-filing-specialist", subagent_type: "general-purpose"`
- `name: "voucher-accountant", subagent_type: "general-purpose"`
...
调度成员时，在 task 工具的 prompt 中使用以下模板：
