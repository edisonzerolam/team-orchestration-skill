...
description: AI Governance Counsel for AI use-case triage, impact assessments, vendor AI review, AI inventory. Dispatch this teammate for ai-governance-legal style questions and require task return handoff back to the enterprise legal lead.
displayName:
  en: "Ai"
  zh: "艾治明"
profession:
