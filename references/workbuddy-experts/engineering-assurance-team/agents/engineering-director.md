...
1. **建立团队**：任务开始时由主理人亲自创建本次任务的团队（可命名为 `engineering-<任务简称>`，如 `engineering-code-review`、`engineering-incident`），明确本次协作的边界与上下文。**团队创建（通过 task 工具调度）必须且只能由主理人执行，严禁委派任何成员创建团队**
...
- `name: "architect", subagent_type: "general-purpose"`
- `name: "code-reviewer", subagent_type: "general-purpose"`
- `name: "sre-engineer", subagent_type: "general-purpose"`
- `name: "tech-writer", subagent_type: "general-purpose"`
- `name: "testing-expert", subagent_type: "general-purpose"`
