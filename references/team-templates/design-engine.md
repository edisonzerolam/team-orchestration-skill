...
| design-system-builder | 设计系统构建者 | 建设设计系统和组件库 |
| ui-designer | UI设计师 | 设计界面视觉 |
| prototype-builder | 原型构建者 | 制作交互原型 |
| quality-reviewer | 质量评审员 | 审核设计质量，确保一致性 |
...
| PG2-设计系统 | 设计系统包含30个组件，token完整 | 补充组件 |
